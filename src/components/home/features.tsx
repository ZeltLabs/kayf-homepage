        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative z-10 mx-auto max-w-2xl space-y-6 text-center">
                    <h2 className="text-balance text-4xl font-semibold lg:text-6xl">Three problems. One solution.</h2>
                    <p>Kayf combines secure communication, intelligent search, and workflow automation into one seamless experience. Built by the community. Made for teams who move fast.</p>
                </div>
                        ...
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center mx-auto">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-center">100%</span>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">Open Source</h2>
                                    <p className="text-foreground">
                                        Kayf is fully open source - you can inspect the code, host it yourself, or fine-tune it to fit your team&apos;s exact needs. No lock-in, no black boxes.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">Kayf uses end-to-end encryption. Only you and your collaborators can access your data - not even we can see it.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-muted-foreground w-full" /* ... */ />
                                </div>
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">AI-powered search</h2>
                                    <p className="text-foreground">Find anything across docs, chats, and notes. Kayf&apos;s semantic search understands meaning, not just keywords.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Automation built-in</h2>
                                        <p className="text-foreground">From weekly reports to smart reminders - Kayf&apos;s automation platform handles the busywork so you don&apos;t have to.</p>
                                    </div>
                                </div>
                                {/* Existing SVG untouched */}
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    <svg className="w-full sm:w-[150%]" /* ... */ />
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Collaborate with others</h2>
                                        <p className="text-foreground">Co-create documents, brainstorm on canvases, or draft ideas - Kayf&apos;s collaboration platform helps your team move from idea to impact.</p>
                                    </div>
                                </div>
                                {/* Existing avatars/visuals */}
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        {/* Your avatar blocks remain unchanged */}
                                        {/* ... */}
                                    </div>
                                </div>
                            </CardContent>
